...
permalink: /life/
title: life
description: Welcome to my amazing life.
nav: true
nav_order: 6
---
...
<p align="center">
  {% include figure.liquid path="assets/img/volunteer_1.png" width="350" alt="Teaching in Tanzania" %}
  <br>
  {% include figure.liquid path="assets/img/volunteer_2.png" width="350" alt="Teaching in Tanzania" %}
</p>

# Macao
I come from Macao, a place I deeply love.
In 2024, I served as the President of the Tsinghua University Macao Cultural Association and co-founded a three-day [Macao Food Festival](https://www.macaodaily.com/html/2024-10/24/content_1789647.htm) in the university cafeteria. We invited 11 master chefs from Macao, and the event attracted over 20,000 attendees. Some participants even queued for more than three hours.
...
<p align="center">
  {% include figure.liquid path="assets/img/macau_food.png" width="350" alt="Scenes from the Macao Food Festival" %}
</p>

# Taekwondo
I have loved Taekwondo since the 6th grade.
...
<p align="center">
  {% include figure.liquid path="assets/img/taekwondo.png" width="350" alt="Side kick at Tsinghua's Main Auditorium." %}
</p>
...
<p align="center">
  {% include figure.liquid path="assets/img/antarctica.png" width="350" alt="Me in Antarctica" %}
</p>